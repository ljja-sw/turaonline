...
<section class="container-fluid my-3">
    ...
    <div class="row">
     ...
     <div class="col-md-6">
        <?php $query = "SELECT empresas.nombre, correo, nit, direccion,sector_empresarial.nombre as nombre_sector FROM empresas INNER JOIN sector_empresarial ON empresas.id_sector = sector_empresarial.id ORDER BY fecha_registro LIMIT 1";
...
<div class="row">
    <div class="col-md-6">
        <?php $query = "SELECT empresas.nombre, correo, nit, direccion, puntuaciones.puntaje, puntuaciones.descripcion,sector_empresarial.nombre as nombre_sector FROM empresas INNER JOIN sector_empresarial  ON empresas.id_sector = sector_empresarial.id INNER JOIN puntuaciones on puntuaciones.id_empresa = empresas.id ORDER BY fecha_registro LIMIT 1";
        $resultado = $f->ejecutarQuery($query); ?>
