...
if(mysqli_num_rows($resultado)>0){
	...
	while ($fila = mysqli_fetch_assoc($resultado)) {
		...
		if (file_exists("../store/empresas/".$fila['nit']."/img/".$fila['id_empresa'].".png")) {
		...
		<div class="card card-empresa">
			<?php echo "../store/empresas/".$fila['nit']."/img/".$fila['id_empresa'].".png"; ?>
			<div class="card-body row">
				...
				<div class="col-md-2 align-self-end">
					<a class="float-right" href="empresas/info.php?id=<?php echo $fila['nit'] ?>">Info <i class=" fi-arrow-right"></i> </a>
				</div>
			</div>
		</div>
