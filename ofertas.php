			...
			<div class="col-12 col-md-4 nav_lateral">
				<div class="fecha_publicacion card">
					...
					<div class="cont" >
						...
						<div class="row">
							<label class="col-9 col-md-10" for="U2D">Último 2 días</label><input class="col-3 col-md-2 input" id="U2D" type="checkbox">
						</div>
						<div class="row">
							<label class="col-9 col-md-10" for="US">Última samana</label><input class="col-3 col-md-2 input" id="US" type="checkbox">
						</div>
						<div class="row">
							<label class="col-9 col-md-10" for="U15D">Últimos 15 días</label><input class="col-3 col-md-2 input" id="U15D" type="checkbox">
						</div>
						<div class="row">
							<label class="col-9 col-md-10" for="UM">Último mes</label><input class="col-3 col-md-2 input" id="UM" type="checkbox">
						</div>
					</div>
				</div>
				...
				<div class="tipo_jornada card">
					...
					<div class="cont">
						...
						<div class="row">
							<label class="col-9 col-md-10" for="TJ2">Tiempo Parcial</label><input class="col-3 col-md-2 input" id="TJ2" type="checkbox">
						</div>
						<div class="row">
							<label class="col-9 col-md-10" for="TJ3">Por Horas</label><input class="col-3 col-md-2 input" id="TJ3" type="checkbox">
						</div>
						<div class="row">
							<label class="col-9 col-md-10" for="TJ4">Beca/prácticas</label><input class="col-3 col-md-2 input" id="TJ4" type="checkbox">
						</div>
					</div>
				</div>
			</div>
