...
<footer class="page-footer font-small bg-pagina pt-0" style="margin-top: 60px;">
        ...
        <div class="container">
            ...
            <div class="row py-4 d-flex align-items-center">
                ...
                <div class="col-md-6 col-lg-5 text-center text-md-left mb-4 mb-md-0">
                    <h6 class="mb-0 white-text">¡Conéctese con nosotros en las redes sociales!</h6>
                </div>
                <!--Grid column-->
    ...
    <div class="container mt-5 mb-4 text-center text-md-left">
        <div class="row mt-3">
            ...
            <div class="col-md-4 col-lg-3 col-xl-3">
                ...
                <hr class="deep-purple accent-2 mb-4 mt-0 d-inline-block mx-auto" style="width: 60px;">
                <p>
                    <i class="fa fa-home mr-3"></i> Buenaventrua, Valle del Cauca, CO</p>
                <p>
    ...
    <!-- Copyright-->
    <div class="footer-copyright py-3 text">
        © 2018 Copyright:
        <a href="index.php">
            <strong> TuraOnline.com</strong>
        </a>
    </div>
    <!--/.Copyright -->
